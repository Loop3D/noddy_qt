...
/* [Qt port change] todo.txt #41 follow-up: restored to the pre-"vitaliy" Granite petrophysics values. */
...
/* [Qt port change] todo.txt #41 follow-up: restored to the pre-"vitaliy" Limestone petrophysics values. */
