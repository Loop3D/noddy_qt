...
#endif
{
   ...
   {
      if (calcBlock)
         doGeophysics (BLOCK_AND_ANOM, viewOptions, geophOptions, output, blockFile, NULL, 0, NULL, NULL, NULL);
      else
...
#endif
{
   ...
   for (i = numMemManagerData-1; i >= 0; i--)
   {
      if (memManagerData[i].data == array)
      {
         ...
         memManagerData[i].dim1 = 0;
         memManagerData[i].dim2 = 0;
         memManagerData[i].dim3 = 0;
         found = TRUE;
      }
   }
