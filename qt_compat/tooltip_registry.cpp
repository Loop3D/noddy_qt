...
extern const IconTooltipEntry g_iconTooltips[] = {
    ...
    { 10001, "Stratigraphy: an ordered sequence\nof flat-lying rock layers, forming\nthe base of every model.\nDrag this icon to the History window first." },
    { 10002, "Fold: bends preexisting geology\ninto a wave-like geometry, with a\nchosen wavelength, amplitude and orientation.\nStratigraphy icon must be present in the History window." },
    ...
    { 10013, "Import: brings in a block of\npre-computed geology from another file.\nStratigraphy icon must be present in the History window." },
